...
if(isset($_POST['submit_btn'])){
  ...
  $end_date = $_POST['end'];
  $read_query = "SELECT  `userid`, `fname`, `date`, `punchin`, `punchout`,`lunchin`,`lunchout`, `upwork_task`, `upwork`, concat(timestampdiff(HOUR,`punchin`,`punchout`),':', timestampdiff(MINUTE,`punchin`,`punchout`)%60,':',
...
if(mysqli_num_rows($data)>0){
  while($row = mysqli_fetch_array($data)){
    ...
    echo "<td style='text-align:center;'>".$row['upwork']."</td>";
